...
public class PlaceVO_Hibernate implements Serializable {
    ...
    public PlaceVO_Hibernate() {
        super();
    }
    public PlaceVO_Hibernate(String pla_no, String name, String lng, String lat, String addr, String pla_desc, Set<PlaceViewVO> placeViewSet) {
        super();
        this.pla_no = pla_no;
        this.name = name;
        this.lng = lng;
