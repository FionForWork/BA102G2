...
<div class="col-xs-12 col-sm-7">
	...
	<div class="form-group">
		...
		年分<input type="text" class="form-control"  name="year" onkeypress="if (window.event.keyCode==13) return false;">
		月份<input type="text" class="form-control"  name="month" onkeypress="if (window.event.keyCode==13) return false;">
		日<input type="text" class="form-control"  name="day" onkeypress="if (window.event.keyCode==13) return false;">
	</div>
