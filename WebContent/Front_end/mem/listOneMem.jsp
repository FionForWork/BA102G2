	...
	<div class="row">
		...
		<div class="col-md-offset-1 col-md-2">
			...
			<ul class="list-group">
				...
				<br>
				<a
					href="<%=request.getContextPath()%>/Front_end/reservation/memReservation.jsp"
					class="list-group-item menua ">預約紀錄查詢</a>
				<br>
				<a href="<%=request.getContextPath()%>/Front_end/RFQ/listMyRFQ.jsp"
					class="list-group-item menua">報價紀錄查詢</a>
				<br>
				<a
				...
				<br>
				<a
					href="<%=request.getContextPath()%>/Front_end/Preview/ImageCropper.jsp"
					class="list-group-item menua">實景預覽</a>
				<br>
				<a href="<%=request.getContextPath()%>/Front_end/mall/mallArea.jsp"
		...
		<div class="container" id="big">
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-sm-push-2">
					<h1>
						<img
							src="<%=request.getContextPath()%>/Front_end/mem/img/ring_64.png">個人資料
					</h1>

					<div class="form-group" style="width: 300px;">

						<img class='img-thumbnail'
							src="<%=request.getContextPath()%>/ShowPictureServletDAO?mem_no=${memVO.mem_no}" />

					</div>

					<div class="form-group">
						<span style='font-size:22px'>帳號 :&nbsp</span> ${memVO.id}
					</div>
					<div class="form-group">
						<span style='font-size:22px'>姓名 :&nbsp</span> ${memVO.name}
					</div>
					<div class="form-group">
						<span style='font-size:22px'>性別 :&nbsp</span> ${memVO.sex}
					</div>

					<div class="form-group">
						<span style='font-size:22px'>生日 :&nbsp</span> ${memVO.bday}
					</div>
					<div class="form-group">
						<span style='font-size:22px'>電話 :&nbsp</span> ${memVO.phone}
					</div>
					<div class="form-group">
						<span style='font-size:22px'>電子郵件 :&nbsp</span> ${memVO.email}
					</div>

					<div class="form-group">
						<span style='font-size:22px'>銀行帳戶 :&nbsp</span> ${memVO.account}
					</div>

					<div class="form-group">
						<span style='font-size:22px'>被檢舉次數 :&nbsp</span> ${memVO.report}
					</div>
					<div class="form-group">
						<span style='font-size:22px'>狀態 :&nbsp</span> ${memVO.status}
					</div>
