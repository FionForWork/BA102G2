...
<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title" style="color:#f14195">是否確定預約${map == null?localDate.toString():map.get('cal_date')[0]}的以下服務</h4><hr>
			</div>
			...
			<div class="modal-footer">
				...
				<input type="submit" class="btn btn-danger" value="確認預約">
