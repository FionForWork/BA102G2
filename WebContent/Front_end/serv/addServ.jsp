...
<script>
	$(document).ready(function(){  
		$("#fast6").click(function() {
			...
			$("#content").val('此款式為A Line:直線款這種婚裙乍一看和舞會款似乎並無二異，其實差別還是挺大的，這樣的婚服並沒有寬大的擺裙，而是直線型的垂墜款式，看上去比較硬朗。也有會有褶子的款式，但看上去並不會太過誇張，更加修飾臀型，所以適合臀部比較完美的新娘，不太適合個子不高的新娘，因為腰線不夠明顯。');
