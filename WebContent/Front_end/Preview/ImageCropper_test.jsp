	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			<div class="modal-header" style="padding: 20px 50px;">
				...
				<h4>
					<span class="glyphicon glyphicon-picture"></span> 您要從哪裡取得照片?
				</h4>
			</div>

			<div class="modal-body" style="padding: 40px 50px;">

				<button class='btn btn-default' onclick='fromAlbum()'>相簿</button>
				<button class='btn btn-default' onclick='load_image();'>檔案</button>
...
<div class="modal fade" id="selectPicFromAlbModal" role="dialog">
	<div class="modal-dialog modal-lg"
		...
		<div class="modal-content">
				...
				<div id='changeModal'>
					<c:forEach var="contVO" items="${contentList}" varStatus="s">
						<div class="col-md-3 col-sm-6 col-xs-6" style='margin-bottom:30px;'>
							...
							<input type='radio' name='selectPicRadio' value='${contVO.cont_no}' id='${contVO.cont_no}'>
						</div>
					</c:forEach>
				</div>
			...
			<div class="modal-footer">
				<button class='btn btn-info' onclick='selectConfirm()' data-dismiss="modal">確定選擇</button>
...
<script type="text/javascript">
	...
	function showContent(){
		...
		$("#changeModal").load("<%=request.getContextPath()%>/Front_end/Preview/ImageCropper_test.jsp #changeModal",{
			alb_no :alb_no
		});
	}
